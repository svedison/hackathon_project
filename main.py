...
class Game:
	...
	def first_slide(self):
		...
		self.screen.blit(story_text, (75, 100))
		self.screen.blit(story_text2, (75, 150))
		self.screen.blit(story_text3, (75, 200))
		self.screen.blit(story_text4, (300, 300))
	...
	def third_slide(self):
		...
		self.screen.blit(story_text, (75, 100))
		self.screen.blit(story_text2, (75, 150))
		self.screen.blit(story_text3, (300, 300))
